...
(function() {
  ...
  Contract.new = function() {
    if (this.currentProvider == null) {
      throw new Error("DAOInterface error: Please call setProvider() first before calling new().");
    }
    ...
    if (unlinked_libraries != null) {
      ...
      throw new Error("DAOInterface contains unresolved libraries. You must deploy and link the following libraries before you can deploy a new version of DAOInterface: " + unlinked_libraries);
    }
  ...
  Contract.at = function(address) {
    if (address == null || typeof address != "string" || address.length != 42) {
      throw new Error("Invalid address passed to DAOInterface.at(): " + address);
    }
  ...
  Contract.deployed = function() {
    if (!this.address) {
      throw new Error("Cannot find deployed address: DAOInterface not deployed or address not set.");
    }
